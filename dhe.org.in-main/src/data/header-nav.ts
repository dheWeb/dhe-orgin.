...
export const headerNavItems: NavItem[] = [
  ...
  { path: "/contact", title: "Contact" },
  {
    ...
    subMenu: [
      ...
      { path: "https://nitsri.dhe.org.in", title: "Chapter — NIT Srinagar", external: true },
      { path: "https://iitrpr.dhe.org.in", title: "Chapter — IIT Ropar", external: true },
      { path: "https://nitj.dhe.org.in", title: "Chapter — NIT Jalandhar", external: true },
      { path: "https://nitkkr.dhe.org.in", title: "Chapter — NIT Kurukshetra", external: true },
    ],
  },
];
